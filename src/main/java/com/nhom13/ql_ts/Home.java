...
import com.nhom13.Component.ManagerView;
...
import com.nhom13.Component.StatisticTime;
    ...
    public void menuChange(MenuItem item){
        switch(item.getIndex()){
                case 1:
                    ...
                    tbb.add("Loại món",new FoodCategory());
                ...
                case 2:
                    ...
                    panelController.add(new TableManager());
                    repaint();
                    revalidate();
                    break;
                case 3:
                    System.out.println("Quản lí hóa đơn");
                    panelController.add(new BillList());
                    repaint();
                    revalidate();
                    break;
                case 4:
                    System.out.println("Quản lí nhân viên");
                    panelController.add(new EmployeeManager());
                    repaint();
                    revalidate();
                    break;
                case 5:
                    panelController.add(new ClientManager());
                    repaint();
                    revalidate();
                    break;
                case 6:
                    System.out.println("Quản lí khuyến mãi");
                    panelController.add(new SaleManager());
                    repaint();
                    revalidate();
                    break;
                case 7:
                    ...
                    tbb2.add("Theo thời gian",new StatisticTime());
